...
public class TestLambda {
	 ...
	 * 객체화, 부수 효과 최소화를 목표로 선언적 코드(결과를 먼저 적시) 작성 - 자바의 경우, 람다식 + 스트림을 활용, 함수형 프로그래밍을
	 * 작성할 수 있음.
	 * 
	 * 람다식 - 이름이 없는 즉석함수 - 메서드를 간결하게 표현할 수 있으며, 코드를 읽기 쉽고 간단하게 작성 가능
	 * 
	 * 스트림 - 데이터를 물결의 흐름으로 파악, 여러 함수의 로직의 조합을 거치면서 변경되고 변환되는 절차
	 */
...
//		testLambdaParams(10,20,(x,y)-> x+y);
		// 고계함수란?
		// 특정 함수를 거쳐 함수 내부에서 로직이 생성되어 반환되는 함수
//		  함수를 반환하는 함수.
...
//		람다식 구현
		...
		// Java는 몇가지 함수의 패턴을 미리 구현한 인터페이스를 가지고 있음
