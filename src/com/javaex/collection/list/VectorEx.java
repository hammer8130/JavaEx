...
//											  elementAt은 Object를 리턴한다.
		...
		while (e.hasMoreElements()) { // 뒤쪽에 요소가 더 있는가?
			Integer item = (Integer) e.nextElement(); // 특별한 명령 없인 Object가 호출됨. Casting필요
			System.out.print(item + " ");
		}
		System.out.println("\n=========== Iterator"); // Vector 에서 iterator 호출
		Iterator<Integer> e3 =v.iterator();
		while(e3.hasNext()) {
			Integer item = e3.next();
			System.out.print(item+" ");
		}
		System.out.println();
